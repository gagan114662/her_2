...
struct SamanthaBootstrapTests {
    ...
    func ipopFactoryRuntimeIsFileBackedAndParallel() throws {
        ...
        #expect(runtime.contains("discover"))
        #expect(runtime.contains("qualify"))
        #expect(runtime.contains("rank"))
        #expect(runtime.contains("draft"))
        #expect(runtime.contains("approve-rule"))
        #expect(runtime.contains("submit-ready"))
        #expect(runtime.contains("promote-to-milestone"))
        #expect(runtime.contains("RemoteOK"))
        #expect(runtime.contains("rss_jobs"))
        #expect(runtime.contains("quality_gate"))
        #expect(runtime.contains("approved_to_submit"))
        #expect(runtime.contains("revenue_ledger"))
